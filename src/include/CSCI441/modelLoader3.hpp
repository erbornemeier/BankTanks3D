/** @file modelLoader3.hpp
  ...
  */
#ifndef __CSCI441_MODEL_LOADER3_H__
#define __CSCI441_MODEL_LOADER3_H__
...
namespace CSCI441 {
	...
	public:
		...
		/** @brief Loads a model from the given file
			...
			*/
		inline ModelLoader( const char* filename );
		...
		/** @brief Loads a model from the given file
			...
			*/
		inline bool loadModelFile( const char* filename, bool INFO = true, bool ERRORS = true );
		/** @brief Renders a model
			...
			*/
		inline bool draw( GLint positionLocation, GLint normalLocation = -1, GLint texCoordLocation = -1,
		...
		/** @brief Enable autogeneration of vertex normals
		  ...
		  *
			...
			*/
		inline void enableAutoGenerateNormals();
		/** @brief Disable autogeneration of vertex normals
		  ...
		  *
			...
			*/
		inline void disableAutoGenerateNormals();

	private:
		inline void _init();
		inline bool _loadMTLFile( const char *mtlFilename, bool INFO, bool ERRORS );
		inline bool _loadOBJFile( bool INFO, bool ERRORS );
		inline bool _loadOFFFile( bool INFO, bool ERRORS );
		inline bool _loadPLYFile( bool INFO, bool ERRORS );
		inline bool _loadSTLFile( bool INFO, bool ERRORS );
		inline vector<string> _tokenizeString( string input, string delimiters );
...
namespace CSCI441_INTERNAL {
	inline unsigned char* createTransparentTexture( unsigned char *imageData, unsigned char *imageMask, int texWidth, int texHeight, int texChannels, int maskChannels );
	inline void flipImageY( int texWidth, int texHeight, int textureChannels, unsigned char *textureData );
}
